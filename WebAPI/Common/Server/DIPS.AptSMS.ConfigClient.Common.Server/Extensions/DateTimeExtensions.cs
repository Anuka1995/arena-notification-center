...
namespace DIPS.AptSMS.ConfigClient.Common.Server.Extensions
{
    public static class DateTimeExtensions
    {
        ...
        /// <summary>
        /// Returns original <see cref="DateTime"/> value with time part set to midnight.
        /// </summary>
        ...
        public static int WeekOfYear(this DateTime current)
        {
            return CultureInfo.CurrentCulture.Calendar.GetWeekOfYear(current, CultureInfo.CurrentCulture.DateTimeFormat.CalendarWeekRule, CultureInfo.CurrentCulture.DateTimeFormat.FirstDayOfWeek);
        }
